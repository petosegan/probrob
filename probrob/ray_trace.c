...
static char __pyx_k_pr_dot_s[] = "pr_dot_s";
...
static PyObject *__pyx_pw_7probrob_9ray_trace_1ray_trace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_edges,&__pyx_n_s_pose,&__pyx_n_s_theta,&__pyx_n_s_rmax,0};
...
static PyObject *__pyx_pf_7probrob_9ray_trace_ray_trace(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_edges, PyObject *__pyx_v_pose, PyObject *__pyx_v_theta, PyObject *__pyx_v_rmax) {
  ...
  float __pyx_v_pr0;
  float __pyx_v_pr1;
  float __pyx_v_cross_pr_s;
  float __pyx_v_x0;
  float __pyx_v_y0;
  float __pyx_v_phi;
  float __pyx_v_s0;
  float __pyx_v_s1;
  float __pyx_v_pr_dot_s;
  float __pyx_v_u;
  float __pyx_v_cross_pr_q;
  float __pyx_v_t;
 ...
 *     for edge in edges:
 */
  if ((likely(PyTuple_CheckExact(__pyx_v_pose))) || (PyList_CheckExact(__pyx_v_pose))) {
    PyObject* sequence = __pyx_v_pose;
    #if CYTHON_COMPILING_IN_CPYTHON
 ...
 */
    __pyx_t_14 = ((__pyx_v_u > 1.0) != 0);
    if (!__pyx_t_14) {
    } else {
      __pyx_t_12 = __pyx_t_14;
      goto __pyx_L11_bool_binop_done;
    }
    __pyx_t_14 = ((__pyx_v_u < 0.0) != 0);
    __pyx_t_12 = __pyx_t_14;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cross_pr_q, __pyx_k_cross_pr_q, sizeof(__pyx_k_cross_pr_q), 0, 0, 1, 1},
  {&__pyx_n_s_cross_pr_s, __pyx_k_cross_pr_s, sizeof(__pyx_k_cross_pr_s), 0, 0, 1, 1},
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ray_trace(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ray_trace", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
